...
class Usuario
{
    ...
    {
        return "$this->_Nombre,$this->_Mail";
    }
    ...
    private static function BuscarFoto($id)
    {
        return "<img src=\"./Usuario/Fotos/$id.png\" alt=\"foto\"/>";
    }
    ...
    public static function ListarUsuarios($listado)
    {
        ...
        foreach ($listado as $usuario) {
            ...
            $salida .= "<li>" . $usuario->MostrarDatos() . self::BuscarFoto($usuario->GetId()) . "</li>";
        }
        $salida .= "</ul>";
        return $salida;
    }
